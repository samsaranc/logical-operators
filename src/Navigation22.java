...
public class Navigation{
	...
	//-------------------------------------
		...
		double hBlueMin = 210.0;
		double hBlueMax = 230.0;
		double sBlueMin = 0.0;
	    double sBlueMax = 2.0;
	    double vBlueMin = 0.0;
	    double vBlueMax = 2.0;
	    double hBlackMin = 5.0;
	    double hBlackMax = 9.0;
	    double sBlackMin = 0.0;
	    double sBlackMax = 2.0;
	    double vBlackMin = 0.0;
	    double vBlackMax = 2.0;
